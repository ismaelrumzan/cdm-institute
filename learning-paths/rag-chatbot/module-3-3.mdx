...
You can test the function by calling it in your browser's developer console or by adding a temporary test route:

<AccordionGroup>
  <Accordion title="Option 1: Browser Developer Console">
    1. **Open Developer Tools**:

    - Press `F12` or right-click and select "Inspect"
    - Go to the "Console" tab

    2. **Import the function** (if using ES modules):

    ```javascript
    import { testEmbeddingGeneration } from "./lib/ai/embedding";
    ```

    3. **Or call it directly** (if the function is globally available):
    ```javascript
  ...
  <Accordion title="Option 2: Create a Test Route">
    Add a temporary test route to your Next.js app:
    ...
    Then visit `/api/test-embeddings` in your browser to run the test.

  </Accordion>

  <Accordion title="Option 3: Test File">
